...
func TestRunExecutesHistoricalReplay(t *testing.T) {
	data := strings.Join([]string{
		...
		"2026-03-10T09:30:00Z,APVO,11.70,11.86,11.66,11.84,220000,10.01",
		"2026-03-10T09:31:00Z,APVO,11.84,12.12,11.80,12.10,260000,10.01",
		"2026-03-10T09:32:00Z,APVO,12.10,12.35,12.06,12.32,320000,10.01",
		"2026-03-10T09:33:00Z,APVO,12.32,12.42,12.20,12.38,180000,10.01",
		"2026-03-10T09:34:00Z,APVO,12.30,12.32,11.40,11.55,170000,10.01",
	}, "\n")
...
func TestRunExecutesHistoricalReplayFromInputBars(t *testing.T) {
	result, err := Run(context.Background(), config.DefaultTradingConfig(), RunConfig{
		Bars: []InputBar{
			...
			{Timestamp: time.Date(2026, 3, 10, 9, 30, 0, 0, time.UTC), Symbol: "APVO", Open: 11.70, High: 11.86, Low: 11.66, Close: 11.84, Volume: 220_000, PrevClose: 10.01},
			{Timestamp: time.Date(2026, 3, 10, 9, 31, 0, 0, time.UTC), Symbol: "APVO", Open: 11.84, High: 12.12, Low: 11.80, Close: 12.10, Volume: 260_000, PrevClose: 10.01},
			{Timestamp: time.Date(2026, 3, 10, 9, 32, 0, 0, time.UTC), Symbol: "APVO", Open: 12.10, High: 12.35, Low: 12.06, Close: 12.32, Volume: 320_000, PrevClose: 10.01},
			{Timestamp: time.Date(2026, 3, 10, 9, 34, 0, 0, time.UTC), Symbol: "APVO", Open: 12.30, High: 12.32, Low: 11.40, Close: 11.55, Volume: 170_000, PrevClose: 10.01},
		},
	})
	if err != nil {
